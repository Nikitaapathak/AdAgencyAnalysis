...
CREATE TABLE `client` (
  ...
  `Client_Phone_no` int DEFAULT NULL,
  `Client_Type` varchar(100) DEFAULT NULL,
  `Client_Budget` int DEFAULT NULL,
  `Client_Ad_Type` varchar(50) DEFAULT NULL,
  `Client_location` varchar(60) DEFAULT NULL,
...
-- Dump completed on 2022-11-21 21:03:27
